# Code entnommen von folgender Seite: https://ls11-www.cs.tu-dortmund.de/rudolph/hypervolume/start
# Folgende Anpassungen wurden vorgenommen:
    # xrange wurde zu range verändert, um auf die Syntax der neueren Python-Versionen zu passen
    # sortByDimension wurde angepasst, um die Klasse Hypervolume zu nutzen
